...
_SAM3_DIR = os.path.dirname(__file__)
_BPE_PATH = os.path.join(_SAM3_DIR, "assets", "bpe_simple_vocab_16e6.txt.gz")
import torch
...
def build_sam3_image_model(
    ...
    if enable_inst_interactivity:
        sam3_pvs_base = build_tracker(apply_temporal_disambiguation=False, with_backbone=True)
